...
public final class ServerReflectionGrpc {
  ...
  public static final String SERVICE_NAME = "helloworld.ServerReflection";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.grpc.examples.helloworld.ServerReflectionRequest,
      io.grpc.examples.helloworld.ServerReflectionResponse> getServerReflectionInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ServerReflectionInfo",
      requestType = io.grpc.examples.helloworld.ServerReflectionRequest.class,
      responseType = io.grpc.examples.helloworld.ServerReflectionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<io.grpc.examples.helloworld.ServerReflectionRequest,
      io.grpc.examples.helloworld.ServerReflectionResponse> getServerReflectionInfoMethod() {
    io.grpc.MethodDescriptor<io.grpc.examples.helloworld.ServerReflectionRequest, io.grpc.examples.helloworld.ServerReflectionResponse> getServerReflectionInfoMethod;
      ...
      synchronized (ServerReflectionGrpc.class) {
        if ((getServerReflectionInfoMethod = ServerReflectionGrpc.getServerReflectionInfoMethod) == null) {
          ServerReflectionGrpc.getServerReflectionInfoMethod = getServerReflectionInfoMethod =
              io.grpc.MethodDescriptor.<io.grpc.examples.helloworld.ServerReflectionRequest, io.grpc.examples.helloworld.ServerReflectionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ServerReflectionInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.helloworld.ServerReflectionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.grpc.examples.helloworld.ServerReflectionResponse.getDefaultInstance()))
  ...
  public static abstract class ServerReflectionImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.ServerReflectionRequest> serverReflectionInfo(
        io.grpc.stub.StreamObserver<io.grpc.examples.helloworld.ServerReflectionResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                io.grpc.examples.helloworld.ServerReflectionRequest,
                io.grpc.examples.helloworld.ServerReflectionResponse>(
